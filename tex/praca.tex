...
% Tytuł pracy
				\put(80,320){\Huge \textsc{Rozpoznawanie emocji}}
				\put(80,280){\Huge \textsc{tłumów metodami}}
				\put(80,240){\Huge \textsc{uczenia maszynowego}}
% Autor pracy
				\put(90,200){\makebox(0,0)[l]{\large \textsc{Eryk Krupa}}}
				\put(90,180){\makebox(0,0)[l]{\large \textsc{Nr indeksu: 244993}}}

				\put(200,100){\makebox(0,0)[l]{\large Praca inżynierska napisana}}
				\put(200,80){\makebox(0,0)[l]{\large pod kierunkiem}}
% dane promotora
				\put(200,60){\makebox(0,0)[l]{\large dr inż. Jakuba Lemiesza}}
